...
class MostViewedBlock extends BlockBase
{
    private function buildContent()
    {
        ...
        $query->leftJoin('node__field_header_image', 'fi', 'nfd.nid = fi.entity_id');
        $query->leftJoin('file_managed', 'fim', 'fim.fid = fi.field_header_image_target_id');

        $query->innerJoin('node_counter', 'nc', 'nfd.nid = nc.nid');
